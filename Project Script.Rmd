...
Map of where shrimp were actually caught and their abundances at those locations. Code is only included for Neamap. Will be repeated for seamap and chesmap but only Neamap is shown below for ease of moving on to statistical analysis.
```{r}
